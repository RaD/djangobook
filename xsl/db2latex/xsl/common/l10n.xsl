...
<!-- ********************************************************************
     $Id: l10n.xsl,v 1.1 2005/12/05 08:19:41 rpopov Exp $
     ********************************************************************

     This file derived from the XSL DocBook Stylesheet distribution and changed 
     for DB2LaTeX purposes.

     See http://db2latex.sf.net
