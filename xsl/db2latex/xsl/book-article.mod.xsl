<?xml version='1.0'?>
<!--############################################################################# 
|	$Id: book-article.mod.xsl,v 1.1 2005/12/05 08:19:40 rpopov Exp $
|- #############################################################################
|	$Author: rpopov $												
|														
|   PURPOSE:
...
<xsl:stylesheet 
	...
	<xsl:text>\newcommand{\booktitle}{</xsl:text>
	<xsl:apply-templates select="title|bookinfo/title" mode="maketitle.mode"/>
	<xsl:text>}&#10;</xsl:text>
	<xsl:text>\newcommand{\booksubtitle}{</xsl:text>
	<xsl:apply-templates select="subtitle|bookinfo/subtitle" mode="maketitle.mode"/>
	<xsl:text>}&#10;</xsl:text>
